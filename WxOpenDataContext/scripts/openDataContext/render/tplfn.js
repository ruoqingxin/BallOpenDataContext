...
// template from assets/prefab/UIGameRoomView.lh
...
module.exports = function tplFn(it) {
  ...
  var avatarFallback = images["icon_800000.png"] || "openDataContext/image/icon_800000.png";
  var btnImg = images["ui_btn_yellow.png"] || "openDataContext/image/ui_btn_yellow.png";
  var lineImg = images["ui_lt_dgx.png"] || "openDataContext/image/ui_lt_dgx.png";
  var out = '<view id="container" class="container">';

  if (data.length === 0) {
    out += '<text class="emptyText" value="' + escAttr(emptyText) + '"></text>';
  } else {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      out += '<view class="item" id="item_' + i + '" data-openid="' + openid + '">';
      out += '<image class="img_head" src="' + avatar + '"></image>';
      out += '<text class="txt_nick" value="' + nickname + '"></text>';
      out += '<image id="btn_' + i + '" class="btn_invite" src="' + escAttr(btnImg) + '">';
